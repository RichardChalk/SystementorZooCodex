...
const translations = {
  en: {
    ...
    animalsEyebrow: "Animal friends",
    animalsTitle: "Say hello to some zoo favorites",
    animalsIntro: "Meet six friendly animals that curious kids love to spot around the park.",
    challengeEyebrow: "Today's zoo challenge",
    challengeTitle: "Can you spot 3 striped animals?",
    challengeText: "Look closely at fur, feathers, and shells. Tell your grown-up when you find each one.",
    animalLionName: "Lion",
    animalLionText: "A sunny-maned big cat that loves resting, roaring, and watching the world.",
    animalElephantName: "Elephant",
    animalElephantText: "A gentle giant with clever ears, a strong trunk, and a calm walk.",
    animalGiraffeName: "Giraffe",
    animalGiraffeText: "A tall leaf-snacker with long legs and a curious, friendly face.",
    animalZebraName: "Zebra",
    animalZebraText: "A striped runner whose bold coat makes every group look different.",
    animalPenguinName: "Penguin",
    animalPenguinText: "A waddling swimmer that looks dressed up and loves chilly water.",
    animalTurtleName: "Turtle",
    animalTurtleText: "A slow shell-walker that reminds everyone to explore at their own pace.",
  ...
  sv: {
    ...
    animalsEyebrow: "Djurvänner",
    animalsTitle: "Säg hej till några zoo-favoriter",
    animalsIntro: "Möt sex vänliga djur som nyfikna barn gärna spanar efter i parken.",
    challengeEyebrow: "Dagens zooutmaning",
    challengeTitle: "Kan du hitta 3 randiga djur?",
    challengeText: "Titta noga på päls, fjädrar och skal. Berätta för din vuxna när du hittar varje djur.",
    animalLionName: "Lejon",
    animalLionText: "En solmanad stor katt som gillar att vila, ryta och titta på världen.",
    animalElephantName: "Elefant",
    animalElephantText: "En varsam jätte med smarta öron, stark snabel och lugna steg.",
    animalGiraffeName: "Giraff",
    animalGiraffeText: "En lång lövätare med höga ben och ett nyfiket, vänligt ansikte.",
    animalZebraName: "Zebra",
    animalZebraText: "En randig springare vars tydliga mönster gör varje grupp unik.",
    animalPenguinName: "Pingvin",
    animalPenguinText: "En vaggande simmare som ser uppklädd ut och gillar svalt vatten.",
    animalTurtleName: "Sköldpadda",
    animalTurtleText: "En lugn skalvandrare som visar att man kan utforska i sin egen takt.",
